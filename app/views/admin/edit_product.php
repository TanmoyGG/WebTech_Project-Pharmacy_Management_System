...
<div class="container" style="margin-top: 20px;">
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>admin/editProductProcess" onsubmit="return validateProductForm()">
                <!-- Hidden product ID -->
                ...
                <div style="display: flex; gap: 10px; margin-top: 20px;">
                    ...
                    <a href="<?php echo BASE_URL; ?>admin/inventory" class="btn btn-secondary" style="text-decoration: none;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
